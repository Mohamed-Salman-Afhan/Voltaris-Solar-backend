...
var initializeScheduler = function () {
    ...
    node_cron_1.default.schedule(schedule, function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("[".concat(new Date().toISOString(), "] Starting daily energy generation records sync..."));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, sync_energy_generation_records_1.syncEnergyGenerationRecords)()];
                case 2:
                    _a.sent();
                    console.log("[".concat(new Date().toISOString(), "] Daily sync completed successfully"));
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.error("[".concat(new Date().toISOString(), "] Daily sync failed:"), error_1);
                    return [3 /*break*/, 4];
    ...
    node_cron_1.default.schedule("0 1 1 * *", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("[".concat(new Date().toISOString(), "] Starting monthly invoice generation..."));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../application/background/generate-invoices")); })];
                case 2:
                    generateMonthlyInvoices = (_a.sent()).generateMonthlyInvoices;
                    return [4 /*yield*/, generateMonthlyInvoices()];
                case 3:
                    _a.sent();
                    console.log("[".concat(new Date().toISOString(), "] Monthly invoice generation completed successfully"));
                    return [3 /*break*/, 5];
                case 4:
                    error_2 = _a.sent();
                    console.error("[".concat(new Date().toISOString(), "] Monthly invoice generation failed:"), error_2);
                    return [3 /*break*/, 5];
