...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var record, unitId, pipeline, results, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, EnergyGenerationRecord_1.EnergyGenerationRecord.findOne()];
            case 2:
                record = _a.sent();
                if (!record) {
                ...
                unitId = record.solarUnitId;
                console.log("Testing with Unit ID: ".concat(unitId));
                pipeline = [
...
run();
//# sourceMappingURL=debug-aggregation.js.map