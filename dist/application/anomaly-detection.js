...
var AnomalyDetectionService = /** @class */ (function () {
     ...
     */
    AnomalyDetectionService.analyzeRecords = function (newRecords) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        records.sort(function (a, b) { return new Date(a.timestamp).getTime() - new Date(b.timestamp).getTime(); });
    ...
    AnomalyDetectionService.detectInstantaneousAnomalies = function (unitId, records) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.createAnomalyIfNotExists(unitId, 'ZERO_GENERATION', 'CRITICAL', date, "Zero output detected during peak sunlight hours", { expectedValue: 200, actualValue: energy, deviationPercent: 100 })];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        ...
                        prev = records[i - 1];
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, EnergyGenerationRecord_1.EnergyGenerationRecord.findOne({
                            solarUnitId: unitId,
                            timestamp: { $lt: date }
                        }).sort({ timestamp: -1 })];
                    case 5:
                    ...
                    case 6:
                        ...
                        if (!(hoursDiff <= 3)) return [3 /*break*/, 10];
                        if (!(hour >= 8 && hour <= 16)) return [3 /*break*/, 8];
                        if (!(prev.energyGenerated > 20 && energy < (prev.energyGenerated * 0.5))) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.createAnomalyIfNotExists(unitId, 'SUDDEN_DROP', 'WARNING', date, "Sudden >50% drop in output (From ".concat(prev.energyGenerated, " to ").concat(energy, " kWh)"), { expectedValue: prev.energyGenerated, actualValue: energy, deviationPercent: 50 })];
                    case 7:
                        _a.sent();
                        _a.label = 8;
                    case 8:
                        if (!(prev.energyGenerated > 10 && energy > (prev.energyGenerated * 2))) return [3 /*break*/, 10];
                        // Spike
                        return [4 /*yield*/, this.createAnomalyIfNotExists(unitId, 'ERRATIC_FLUCTUATION', 'WARNING', date, "Abnormal energy spike (>100% increase from ".concat(prev.energyGenerated, " to ").concat(energy, " kWh)"), { expectedValue: prev.energyGenerated, actualValue: energy, deviationPercent: 100 })];
                    case 9:
                        // Spike
                        _a.sent();
                        _a.label = 10;
    ...
    AnomalyDetectionService.detectDegradation = function (unitId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Anomaly_1.Anomaly.findOne({
                                solarUnitId: unitId,
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.createAnomalyIfNotExists(unitId, 'PERFORMANCE_DEGRADATION', 'INFO', today, "7-Day average (".concat(Math.round(avg7), "kWh) is ").concat(deviation, "% lower than 30-Day average (").concat(Math.round(avg30), "kWh)"), { expectedValue: Math.round(avg30), actualValue: Math.round(avg7), deviationPercent: deviation })];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5: return [2 /*return*/];
    ...
    AnomalyDetectionService.getAverageEnergy = function (unitId, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, EnergyGenerationRecord_1.EnergyGenerationRecord.aggregate([
                            {
                                $match: {
                                    solarUnitId: new mongoose_1.default.Types.ObjectId(unitId),
    ...
    AnomalyDetectionService.createAnomalyIfNotExists = function (unitId, type, severity, timestamp, desc, metrics) {
        return __awaiter(this, void 0, void 0, function () {
            var exists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Anomaly_1.Anomaly.findOne({
                            solarUnitId: unitId,
                            anomalyType: type,
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Anomaly_1.Anomaly.create({
                                solarUnitId: unitId,
                                anomalyType: type,
                                severity: severity,
                                detectionTimestamp: timestamp,
