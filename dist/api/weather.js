    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, weather_1.getWeatherForUnit)(unit_id)];
            case 1:
                data = _a.sent();
...
weatherRouter.post("/refresh/:unit_id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var unit_id, data, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
