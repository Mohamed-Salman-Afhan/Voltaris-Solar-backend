...
exports.getEnergyStats = void 0;
var energy_service_1 = require("../../application/services/energy.service");
var solar_unit_1 = require("../../domain/dtos/solar-unit");
var errors_1 = require("../../domain/errors/errors");
var energyService = new energy_service_1.EnergyService();
var getEnergyStats = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, results, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, energyService.getEnergyStats(id, results.data)];
            case 1:
                data = _a.sent();
