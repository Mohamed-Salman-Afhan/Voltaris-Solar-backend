...
router.get("/", authentication_middleware_1.authenticationMiddleware, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, User, user, invoices, error_1;
...
// Get single invoice
router.get("/:id", authentication_middleware_1.authenticationMiddleware, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var invoice, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Invoice_1.Invoice.findById(req.params.id)
